...
class XML:
    """
    Класс для получения информации из xml файла
    """
...
class HTML:
    """
    класс для получения html страницы
    """
    ...
    def get_city(self):
        try:
            city = self.html_data.find(class_='link color_gray breadcrumbs__link').span.text
            return city
        except Exception:
            print('exception')
            return None
